...
process HaplotypeCaller {
    ...
    haplotypecaller_java_mem = task.memory.toGiga() < 6 ? 8 : task.memory.toGiga()
    """
    gatk --java-options "-Xmx${haplotypecaller_java_mem}g -Xms6000m -XX:GCTimeLimit=50 -XX:GCHeapFreeLimit=10" \
        HaplotypeCaller \
        -R ${fasta} \
        -I ${bam} \
        ${intervalsOptions} \
